...
public class SchoolMainActivity extends BaseActivity implements View.OnClickListener, AutoScrollTextView.onShowNextMsg, AutoScrollTextView.OnClickTextListener, Handler.Callback {
    ...
    private TextView school_name_tv;    //推广
    ...
    public void getRecomment() {
        RequestManager.getInstance().GetRecommendedProgramsByColumnId(loginName, id, new JsonCallback<BaseResponse<Page<Program>>>(this, true) {
        ...
        if (program.getProgramType() == 1) {
            RequestManager.getInstance().GetVideoPicture(new JsonCallback<BaseResponse<VideoPic>>(this, true) {
                ...
                public void onSuccess(Response<BaseResponse<VideoPic>> response) {
                    ...
                    Intent intent = new Intent(SchoolMainActivity.this, PlayVideoActivity.class);
            ...
            if (TextUtils.isEmpty(program.getLinkUrl())) {
                Toast.makeText(SchoolMainActivity.this, "暂无详情页面数据", Toast.LENGTH_SHORT).show();
            } else {
                startActivity(new Intent(SchoolMainActivity.this, WebViewActivity.class)
